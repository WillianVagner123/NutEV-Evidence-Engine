...
Uma RecommendationCandidate não é uma recomendação final. A entrada no Protocolo NutEV requer lastro documental, claim auditável, qualidade da evidência, ausência de conflito não adjudicado, validação humana e readiness compatível com protocolo.
