...
def run(output: Path) -> dict:
    ...
    with pilot_server() as (base,data,root), sync_playwright() as p:
        ...
        def authenticate(page,label):
            ...
            page.goto(base+'/evidence-library.html',wait_until='networkidle')
        ...
        try:
            ...
            b.reload(wait_until='networkidle');b.locator('#libraryScope').select_option('project')
            ...
            tab=page_in(contexts[0]);tab.goto(base+'/project.html',wait_until='networkidle')
            ...
            a.goto(base+'/project.html?project_id='+data['users']['b']['projects'][0],wait_until='networkidle')
            expect(a.locator('#nutevProjectSelect')).to_have_value(data['users']['a']['projects'][1])
            a.go_back(wait_until='networkidle');a.reload(wait_until='networkidle')
            a.locator('#libraryScope').select_option('project')
            expect(a.locator('#libraryEntries')).not_to_contain_text('PRIVATE_A_BROWSER')
            ...
            a.goto(base+'/exports.html',wait_until='networkidle')
            ...
            a.goto(base+'/search.html',wait_until='networkidle')
            ...
            a.goto(base+'/evidence-library.html',wait_until='networkidle')
            tab.goto(base+'/project.html',wait_until='networkidle')
