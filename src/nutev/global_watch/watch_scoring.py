...
def score_watch_item(item: dict) -> float:
    ...
    bonus = [
        ...
        ("hybrid effectiveness implementation", 18),
        ("hybrid effectiveness-implementation trial", 20),
        ("hybrid effectiveness implementation trial", 20),
        ("effectiveness-implementation trial", 18),
        ("effectiveness implementation trial", 18),
        ("pragmatic implementation trial", 18),
        ("type 2 hybrid effectiveness-implementation", 18),
        ("type 2 hybrid effectiveness implementation", 18),
        ("hybrid type 1", 16),
        ("hybrid type 2", 16),
        ("hybrid type 3", 16),
