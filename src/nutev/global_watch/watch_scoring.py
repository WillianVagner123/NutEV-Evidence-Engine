...
def score_watch_item(item: dict) -> float:
    ...
    bonus = [
        ...
        ("intensive behavioral therapy", 18),
        ("intensive behavioural therapy", 18),
        ("intensive multicomponent behavioral intervention", 18),
        ("intensive multicomponent behavioural intervention", 18),
        ...
        ("intensive medical nutrition therapy", 18),
        ("nutrition referral", 16),
        ("dietitian referral", 16),
        ("dietetic referral", 16),
        ("dietitian consultation", 14),
        ("dietetic consultation", 14),
