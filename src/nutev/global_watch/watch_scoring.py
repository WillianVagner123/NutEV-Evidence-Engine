...
def score_watch_item(item: dict) -> float:
    ...
    bonus = [
        ...
        ("implementation outcomes framework", 16),
        ...
        ("behavior change wheel", 16),
        ("behaviour change wheel", 16),
        ("capability opportunity motivation behavior", 16),
        ("capability opportunity motivation behaviour", 16),
        ("com-b", 16),
