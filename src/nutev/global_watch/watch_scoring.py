...
def score_watch_item(item: dict) -> float:
    ...
    bonus = [
        ...
        ("consolidated framework for implementation research", 18),
        ("cfir", 14),
        ("re-aim", 14),
        ("reach effectiveness adoption implementation maintenance", 14),
        ("implementation mapping", 14),
        ("normalization process theory", 14),
        ("hybrid effectiveness-implementation", 14),
        ("effectiveness-implementation hybrid", 14),
