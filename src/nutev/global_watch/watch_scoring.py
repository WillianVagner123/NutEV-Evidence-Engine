...
def score_watch_item(item: dict) -> float:
    ...
    bonus = [
        ...
        ("lifestyle medicine", 16),
        ("lifestyle medicine intervention", 16),
        ("lifestyle medicine interventions", 16),
        ("lifestyle medicine program", 14),
        ("lifestyle medicine programme", 14),
        ("lifestyle medicine counseling", 14),
        ("lifestyle medicine counselling", 14),
        ("lifestyle medicine approach", 12),
        ("lifestyle medicine approaches", 12),
