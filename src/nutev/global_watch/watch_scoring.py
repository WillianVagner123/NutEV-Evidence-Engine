...
def score_watch_item(item: dict) -> float:
    ...
    bonus = [
        ...
        ("healthy food voucher", 18),
        ("healthy food vouchers", 18),
        ("grocery voucher", 18),
        ("grocery vouchers", 18),
        ("food pantry intervention", 18),
        ("food pantry interventions", 18),
        ("food bank intervention", 18),
        ("food bank interventions", 18),
