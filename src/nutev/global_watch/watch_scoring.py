...
def score_watch_item(item: dict) -> float:
    ...
    bonus = [
        ...
        ("practice facilitation", 12),
        ("quality improvement", 10),
        ("care delivery", 8),
        ("service delivery", 8),
        ("re-aim", 10),
        ("cfir", 10),
        ("hybrid effectiveness-implementation", 12),
        ("hybrid effectiveness implementation", 12),
        ...
        ("eat-lancet", 12),
        ("food is medicine", 15),
        ("produce prescription", 12),
        ("produce prescriptions", 12),
        ("medically tailored meals", 15),
        ("medically tailored groceries", 15),
        ("meal planning", 12),
        ("commensality", 12),
        ("shared meals", 10),
        ("family meals", 10),
