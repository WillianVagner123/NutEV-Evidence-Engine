...
CARDIO_KIDNEY_METABOLIC_NUTRITION_TERMS = [
    ...
    "cardiovascular-kidney-metabolic dietary pattern",
    "cardiovascular kidney metabolic dietary pattern",
...
CARDIO_KIDNEY_METABOLIC_BONUS_TERMS = [
    ("cardiovascular-kidney-metabolic nutrition", 20),
    ("cardiovascular kidney metabolic nutrition", 20),
    ("cardio-kidney-metabolic nutrition", 18),
    ("cardio kidney metabolic nutrition", 18),
    ("ckm nutrition", 18),
    ("ckm health nutrition", 18),
    ("ckm risk nutrition", 18),
    ("ckm syndrome nutrition", 18),
    ("cardiovascular-kidney-metabolic dietary pattern", 18),
    ("cardiovascular kidney metabolic dietary pattern", 18),
    ("cardio-kidney-metabolic dietary intervention", 18),
    ("cardio kidney metabolic dietary intervention", 18),
    ("cardiorenal metabolic nutrition", 16),
]
