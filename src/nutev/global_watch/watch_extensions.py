...
OBESITY_PHARMACOTHERAPY_NUTRITION_TERMS = [
    ...
    "anti-obesity medication meal planning",
...
OBESITY_PHARMACOTHERAPY_BONUS_TERMS = [
    ...
    ("anti-obesity medication weight maintenance", 18),
    ("anti-obesity medication protein intake", 18),
    ("anti-obesity medication muscle preservation", 20),
    ("anti-obesity medication lean mass preservation", 20),
    ("anti-obesity medication meal planning", 16),
    ...
    ("obesity pharmacotherapy weight maintenance", 18),
    ("obesity pharmacotherapy protein intake", 18),
    ("obesity pharmacotherapy muscle preservation", 20),
    ("glp-1 nutrition", 16),
    ("glp-1 dietary counseling", 16),
    ("glp-1 dietary counselling", 16),
    ("glp-1 weight maintenance", 18),
    ("glp-1 protein intake", 18),
    ("glp-1 muscle preservation", 20),
    ("glp-1 lean mass preservation", 20),
    ("glp-1 meal planning", 16),
    ...
    ("glp-1 receptor agonist weight maintenance", 18),
    ("glp-1 receptor agonist protein intake", 18),
    ("glp-1 receptor agonist muscle preservation", 20),
    ("semaglutide nutrition", 18),
    ("semaglutide dietary counseling", 18),
    ("semaglutide dietary counselling", 18),
    ("semaglutide protein intake", 18),
    ("semaglutide muscle preservation", 20),
    ("semaglutide weight maintenance", 18),
    ("tirzepatide nutrition", 18),
    ("tirzepatide dietary counseling", 18),
    ("tirzepatide dietary counselling", 18),
    ("tirzepatide protein intake", 18),
    ("tirzepatide muscle preservation", 20),
    ("tirzepatide weight maintenance", 18),
    ("incretin therapy nutrition care", 18),
    ("incretin therapy dietary counseling", 16),
    ("incretin therapy dietary counselling", 16),
    ("incretin therapy protein intake", 18),
    ("incretin therapy muscle preservation", 20),
]
