...
OBESITY_PHARMACOTHERAPY_NUTRITION_TERMS = [
    ...
    "anti-obesity medication protein adequacy",
    "anti-obesity medication muscle preservation",
    "anti-obesity medication lean mass preservation",
    ...
    "obesity pharmacotherapy protein intake",
    "obesity pharmacotherapy protein adequacy",
    "obesity pharmacotherapy muscle preservation",
    "obesity pharmacotherapy lean mass preservation",
    "glp-1 nutrition",
    "glp-1 dietary counseling",
    "glp-1 dietary counselling",
    "glp-1 protein intake",
    "glp-1 protein adequacy",
    ...
    "glp-1 receptor agonist protein intake",
    "glp-1 receptor agonist protein adequacy",
    "glp-1 receptor agonist muscle preservation",
    "glp-1 receptor agonist lean mass preservation",
    "incretin therapy nutrition care",
    "incretin therapy dietary counseling",
    "incretin therapy dietary counselling",
    "incretin therapy protein intake",
    "incretin therapy protein adequacy",
    "incretin therapy muscle preservation",
    "incretin therapy lean mass preservation",
]
...
OBESITY_PHARMACOTHERAPY_BONUS_TERMS = [
    ...
    ("anti-obesity medication protein adequacy", 18),
    ("anti-obesity medication muscle preservation", 18),
    ("anti-obesity medication lean mass preservation", 18),
    ...
    ("obesity pharmacotherapy protein intake", 18),
    ("obesity pharmacotherapy protein adequacy", 18),
    ("obesity pharmacotherapy muscle preservation", 18),
    ("obesity pharmacotherapy lean mass preservation", 18),
    ("glp-1 nutrition", 16),
    ("glp-1 dietary counseling", 16),
    ("glp-1 dietary counselling", 16),
    ("glp-1 protein intake", 16),
    ("glp-1 protein adequacy", 16),
    ("glp-1 muscle preservation", 16),
    ("glp-1 lean mass preservation", 16),
    ...
    ("glp-1 receptor agonist protein intake", 18),
    ("glp-1 receptor agonist protein adequacy", 18),
    ("glp-1 receptor agonist muscle preservation", 18),
    ("glp-1 receptor agonist lean mass preservation", 18),
    ("incretin therapy nutrition care", 18),
    ("incretin therapy dietary counseling", 16),
    ("incretin therapy dietary counselling", 16),
    ("incretin therapy protein intake", 16),
    ("incretin therapy protein adequacy", 16),
    ("incretin therapy muscle preservation", 16),
    ("incretin therapy lean mass preservation", 16),
]
