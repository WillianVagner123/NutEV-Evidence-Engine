...
SEMANTIC_RESEARCH_BLOCKS: dict[str, SemanticBlock] = {
    ...
    "choice_architecture_nudging": {
        "terms": [
            ...
            "behavioural economic intervention",
            "default option",
            "default options",
        ...
        "document_terms": [
            ...
            "behavioural economics intervention",
            "point-of-choice prompt",
            "point of choice prompt",
            "food environment intervention",
            "menu labeling intervention",
            "menu labelling intervention",
            "front-of-pack labeling intervention",
            "front-of-pack labelling intervention",
            "portion size intervention",
            "cafeteria intervention",
            "supermarket intervention",
            "grocery store intervention",
