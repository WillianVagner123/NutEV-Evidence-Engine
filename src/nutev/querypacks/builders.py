...
METABOLIC_REMISSION_TERMS = [
    ...
    "formula diet remission",
    "meal replacement remission",
...
METABOLIC_REMISSION_WEB_HINTS = [
    ...
    "diabetes remission clinical practice guideline",
    "diabetes remission position statement",
    "diabetes remission systematic review",
    "diabetes remission trial",
    "type 2 diabetes reversal trial",
    "low energy diet remission trial",
    "total diet replacement remission trial",
    "meal replacement remission trial",
