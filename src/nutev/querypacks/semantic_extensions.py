...
PRECISION_PERSONALIZED_NUTRITION_TERMS = [
    ...
    "adaptive dietary intervention for cardiometabolic risk",
    "adaptive dietary intervention for obesity",
    "adaptive dietary intervention for type 2 diabetes",
    "algorithm-guided dietary advice for cardiometabolic risk",
    "algorithm guided dietary advice for cardiometabolic risk",
    "algorithm-guided dietary advice for obesity",
    "algorithm guided dietary advice for obesity",
    "algorithm-guided dietary advice for type 2 diabetes",
    "algorithm guided dietary advice for type 2 diabetes",
    "digital personalized nutrition for cardiometabolic risk",
    "digital personalised nutrition for cardiometabolic risk",
    "digital personalized nutrition for obesity",
    "digital personalised nutrition for obesity",
    "digital personalized nutrition for type 2 diabetes",
    "digital personalised nutrition for type 2 diabetes",
]
...
PRECISION_PERSONALIZED_NUTRITION_DOCUMENT_TERMS = [
    ...
    "algorithm guided dietary advice",
    "digital personalized nutrition intervention",
    "digital personalised nutrition intervention",
