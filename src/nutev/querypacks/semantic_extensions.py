...
SOCIAL_NEEDS_FOOD_ACCESS_DOCUMENT_TERMS = [
    ...
    "nutrition assistance referral program",
    "community resource referral program",
    "social care integration program",
    "clinic-community linkage program",
    "clinic community linkage program",
