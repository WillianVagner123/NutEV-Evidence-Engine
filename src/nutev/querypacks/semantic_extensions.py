...
PRECISION_PERSONALIZED_NUTRITION_TERMS = [
    ...
    "precision nutrition intervention for metabolic syndrome",
    ...
    "tailored meal planning for cardiometabolic risk",
    ...
    "adaptive nutrition intervention for obesity",
    "adaptive dietary intervention for type 2 diabetes",
    "algorithm-guided dietary intervention",
    "algorithm guided dietary intervention",
    "digital personalized nutrition",
    "digital personalised nutrition",
    "phenotype-tailored diet",
    "phenotype tailored diet",
]
...
PRECISION_PERSONALIZED_NUTRITION_DOCUMENT_TERMS = [
    ...
    "phenotype-tailored diet intervention",
    "phenotype tailored diet intervention",
