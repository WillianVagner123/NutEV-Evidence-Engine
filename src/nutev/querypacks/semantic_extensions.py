...
BEHAVIORAL_OBESITY_TREATMENT_TERMS = [
    ...
    "intensive behavioural weight management",
...
BEHAVIORAL_OBESITY_TREATMENT_DOCUMENT_TERMS = [
    "behavioral obesity treatment trial",
    "behavioural obesity treatment trial",
    "behavioral obesity treatment systematic review",
    "behavioural obesity treatment systematic review",
    "intensive behavioral therapy for obesity guideline",
    "intensive behavioural therapy for obesity guideline",
    "intensive behavioral therapy for obesity systematic review",
    "intensive behavioural therapy for obesity systematic review",
    "comprehensive lifestyle intervention trial",
    "comprehensive lifestyle intervention systematic review",
    "multicomponent lifestyle intervention trial",
    "multi-component lifestyle intervention trial",
    "structured weight management program evaluation",
    "structured weight management programme evaluation",
    "adult weight management program evaluation",
    "adult weight management programme evaluation",
    "obesity management program evaluation",
    "obesity management programme evaluation",
...
def apply_semantic_extensions() -> None:
    ...
    for block_name in (
        ...
        _extend_semantic_block(
            block_name,
            terms=BEHAVIORAL_OBESITY_TREATMENT_TERMS,
            document_terms=BEHAVIORAL_OBESITY_TREATMENT_DOCUMENT_TERMS,
        )
    for block_name in (
        "adherence_persistence",
        "cardiometabolic_precision",
