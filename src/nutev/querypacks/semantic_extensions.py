...
SOCIAL_NEEDS_FOOD_ACCESS_DOCUMENT_TERMS = [
    ...
    "grocery prescription referral program",
...
FOOD_AS_MEDICINE_REFERRAL_TERMS = [
    ...
    "grocery prescription implementation",
...
FOOD_AS_MEDICINE_REFERRAL_DOCUMENT_TERMS = [
    ...
    "food pharmacy intervention trial",
    "food farmacy program evaluation",
    "fresh food pharmacy program evaluation",
    "fresh food pharmacy implementation study",
    ...
    "healthy grocery prescription intervention trial",
