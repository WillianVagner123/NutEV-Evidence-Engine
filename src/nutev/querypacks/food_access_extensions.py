...
FOOD_ACCESS_BENEFIT_TERMS = [
    ...
    "healthy food navigator",
    "healthy food navigators",
...
FOOD_ACCESS_BENEFIT_DOCUMENT_TERMS = [
    ...
    "healthy food referral program evaluation",
    ...
    "food is medicine referral program evaluation",
    "medically tailored meal referral program evaluation",
    "medically tailored grocery referral program evaluation",
