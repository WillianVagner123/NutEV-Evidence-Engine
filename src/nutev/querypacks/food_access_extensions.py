...
FOOD_ACCESS_BENEFIT_TERMS = [
    ...
    "csa share",
    "csa shares",
    "farm share prescription",
    "farm share prescriptions",
    "farm box prescription",
    "farm box prescriptions",
    "farm fresh food box",
...
FOOD_ACCESS_BENEFIT_DOCUMENT_TERMS = [
    ...
    "community supported agriculture program evaluation",
    "community-supported agriculture program evaluation",
    "csa produce box program evaluation",
    "farm share prescription program evaluation",
    "farm box prescription intervention trial",
    "community food referral program evaluation",
