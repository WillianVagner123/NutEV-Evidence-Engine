...
FOOD_ACCESS_BENEFIT_DOCUMENT_TERMS = [
    ...
    "food security screening evaluation",
    "food security intervention trial",
    "food security referral program evaluation",
    "food insecurity screening evaluation",
    "food insecurity referral program evaluation",
    ...
    "nutrition security referral program evaluation",
    ...
    "social needs food referral program evaluation",
