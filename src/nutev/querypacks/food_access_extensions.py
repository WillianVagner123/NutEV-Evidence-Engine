...
FOOD_ACCESS_BENEFIT_TERMS = [
    ...
    "community produce box",
    "community produce boxes",
    "csa produce box",
    "csa produce boxes",
    "community-supported agriculture produce box",
    "community supported agriculture produce box",
    "farm share",
    "farm shares",
    "fresh food delivery",
...
FOOD_ACCESS_BENEFIT_DOCUMENT_TERMS = [
    ...
    "community produce box program evaluation",
    "csa produce box program evaluation",
    "farm share program evaluation",
    "fresh food delivery program evaluation",
    "produce delivery intervention trial",
    "mobile produce market program evaluation",
    "mobile farmers market intervention trial",
    "community food distribution program evaluation",
    "healthy food distribution intervention trial",
