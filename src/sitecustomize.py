    ...
    if original_build is not None and not getattr(original_build, "_nutev_foodmed_patched", False):
        def wrapped_build(keyword_taxonomy: dict, workstream: str) -> list[str]:
            ...
            if ws == "busca2b":
                ...
                queries.append('("diet quality index" OR "healthy eating index" OR "dietary inflammatory index") AND ("obesity" OR "cardiometabolic" OR "type 2 diabetes" OR "hypertension" OR "dyslipidemia" OR "MASLD" OR "NAFLD")')
