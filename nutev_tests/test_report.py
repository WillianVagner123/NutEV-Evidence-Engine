...
def _seed_run(root):
    ...
    records = [
        {"title": "Mediterranean diet and obesity", "authors": "Silva J; Souza M", "year": "2021", "journal": "Nutrients",
        ...
        {"title": "Plant-based patterns", "authors": "", "year": "", "journal": "", "doi": "", "url": "http://y",
