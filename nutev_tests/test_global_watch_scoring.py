...
def test_behavior_change_framework_terms_score_above_generic_note():
    assert score_watch_item({"title": "behavior change wheel and theoretical domains framework for dietary adherence", "relevance_score": 1, "is_new": True}) > score_watch_item({"title": "generic nutrition note", "relevance_score": 1})
