...
def test_autodeploy_restores_reviewed_article1_owner_pins_from_protected_runtime_file() -> None:
    # The owner-pin sync lives in the remote script now, alongside the rest of the deploy
    # logic; the ordering assertions below still pin it ahead of recovery and promotion.
    workflow = deploy_surface_text()
