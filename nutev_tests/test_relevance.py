...
def test_configured_hepatic_fat_measurement_terms_gain_busca2b_priority() -> None:
    scoring_rules = load_json(Path("config/scoring_rules.json"))
    boosted = score_record(
        {
            "title": "Lifestyle nutrition intervention for hepatic steatosis and intrahepatic fat in adults with obesity",
            "abstract": "The program tracked liver fat content and dietary adherence during cardiometabolic follow-up.",
            "source": "pubmed",
        },
        scoring_rules,
        "busca2b",
    ...
    baseline = score_record(
        {
            "title": "Lifestyle nutrition intervention for fatty liver in adults with obesity",
            "abstract": "The program tracked general metabolic follow-up and dietary adherence.",
            "source": "pubmed",
        },
        scoring_rules,
        "busca2b",
