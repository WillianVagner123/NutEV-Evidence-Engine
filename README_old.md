...
## NutEV/NutMEV local engine

### Visão
Pipeline local para curadoria e síntese científica NutEV/NutMEV com workstreams `busca1`, `busca2a`, `busca2b`, `a3`.

### Dependências (NutEV)
`requests`, `pypdf`, `pdf2image`, `python-docx`, `openpyxl`, `pandas`, `beautifulsoup4`, `pytesseract`, `Pillow`.

### OCR (Tesseract)
Necessário Tesseract instalado localmente para OCR de imagens e PDFs escaneados.
...
- `02_metadata/rayyan_ready.csv`
- `03_corpus/download_manifest.csv`
- `03_corpus/failed_downloads.csv`
- `05_extraction/extraction_manifest.csv`
- `06_tables/NUTEV_EVIDENCE_MASTER.xlsx`
- `06_tables/NUTEV_QUESTIONNAIRE_ITEM_CANDIDATES.xlsx`
- `06_tables/NUTEV_FRAMEWORK_COMPONENTS.xlsx`
- `06_tables/NUTEV_TOP_DOCUMENTS.csv`
- `06_tables/NUTEV_TOP_DOCUMENTS.xlsx`
- `06_tables/NUTEV_SOURCE_SUMMARY.xlsx`
- `06_tables/NUTEV_DOMAIN_SUMMARY.xlsx`
- `07_logs/run.log`
- `07_logs/run_summary.json`
- `07_logs/run_summary_pretty.txt`

### Limitações reais atuais
- Dependência de disponibilidade de APIs externas.
- OCR de PDF escaneado depende de `pdf2image` + poppler + Tesseract no host.
- Não realiza bypass de paywall.
